...
import { Share2, Gift, Users, TrendingUp, Target, BarChart3, ArrowRight, CheckCircle, Star, Award, Download, Loader2 } from 'lucide-react';
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      const { error } = await supabase.from('leads').insert({
        ...
        requirement: `裂变增长白皮书下载 - 邮箱: ${formData.email}`,
        status: 'pending',
      });
          ...
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            >
              <div className="text-center mb-8">
                <h2 className="text-3xl font-bold text-sky-900 mb-4">获取《裂变增长私域运营白皮书》</h2>
                <p className="text-sky-700/70 max-w-xl mx-auto">深入了解裂变增长最佳实践，包含云集微店、完美日记等头部案例拆解</p>
              </div>
              {isSuccess ? (
